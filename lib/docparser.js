...
YUI.add('docparser', function (Y) {
    ...
    var Lang = Y.Lang,
        ...
        TAGLIST = [
            ...
            'hidden'        // signals comment should be hidden from generated docs
        ],
        ...
        DIGESTERS = {
            ...
            genericBooleanTag: function (tagname, value, target) {
                target[tagname] = true;
            },

            'hidden': 'genericBooleanTag',
    ...
    Y.extend(DocParser, Y.Base, {
        ...
        **/
        ...
        processblock: function (block) {
            ...
            // if item has hidden tag, exclude from processing.
            if (target.hidden) {
                return;
            }
