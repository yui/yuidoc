    ...
    Y.DocBuilder.prototype = {
        ...
        markdown: function (data) {
            ...
            if (this.options.helpers || (html.indexOf('{{#crossLink') > -1)) {
                try {
                    // Escape handlebars statements in code blocks
        ...
        getProjectMeta: function () {
            var obj = {
                meta: {
                    yuiSeedUrl: 'https://yui-s.yahooapis.com/3.5.0/build/yui/yui-min.js',
                    yuiGridsUrl: 'https://yui-s.yahooapis.com/3.5.0/build/cssgrids/cssgrids-min.css'
                }
            };
            if (!this._meta) {
                try {
